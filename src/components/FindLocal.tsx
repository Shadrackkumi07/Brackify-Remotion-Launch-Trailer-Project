...
export const FIND_LOCAL_DURATION =
  INTRO_DURATION + SCENE_DURATION + OUTRO_DURATION;
export const FIND_LOCAL_FPS = 30;
...
export const FindLocal: React.FC = () => {
  return (
    <AbsoluteFill
      style={{
        background:
    ...
    >
      ...
      <Sequence from={SCENES.main.start} durationInFrames={SCENES.main.duration}>
        <AbsoluteFill>
          <MobilePhoneWrapper>
            <PhoneShowcase
              videoSrc="FindLocal and stats/Findlocal.mp4"
              startFrame={0}
